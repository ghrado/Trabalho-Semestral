...
public class Login extends javax.swing.JFrame {
    ...
    private void abrirTelaPrincipal(Usuario usuario) {
        ...
        switch (usuario.getTipoUsuario()) {
            case ADMINISTRADOR -> {
                TelaAdministrador telaAdministrador = new TelaAdministrador(usuario, controleGestorService);
                telaAdministrador.setVisible(true);
            }
            case GERENTE -> {
                TelaGerente telaGerente = new TelaGerente(usuario, controleGestorService);
                telaGerente.setVisible(true);
            }
            case VENDEDOR -> {
                TelaVendedor telaVendedor = new TelaVendedor(usuario, controleGestorService);
                telaVendedor.setVisible(true);
            }
            case CAIXA -> {
                TelaCaixa telaCaixa = new TelaCaixa(usuario, controleGestorService);
